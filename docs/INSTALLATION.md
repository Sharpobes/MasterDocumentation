...
Как сделать так, чтобы предупреждения не было (подпись кода, Trusted Signing, OV/EV-сертификаты,
требования Smart App Control), описано в [docs/CODE_SIGNING.md](CODE_SIGNING.md).
