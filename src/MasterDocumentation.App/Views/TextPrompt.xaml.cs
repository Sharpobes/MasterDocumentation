...
public partial class TextPrompt : Window
{
    ...
    {
        InitializeComponent();Title=title;_allowEmpty=allowEmpty;Input.Text=initial;Input.AcceptsReturn=multiline;Input.VerticalContentAlignment=multiline?VerticalAlignment.Top:VerticalAlignment.Center;
